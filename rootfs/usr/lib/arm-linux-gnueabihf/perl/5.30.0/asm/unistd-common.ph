...
unless(defined(&_ASM_ARM_UNISTD_COMMON_H)) {
    ...
    eval 'sub __NR_rseq () {( &__NR_SYSCALL_BASE + 398);}' unless defined(&__NR_rseq);
    eval 'sub __NR_io_pgetevents () {( &__NR_SYSCALL_BASE + 399);}' unless defined(&__NR_io_pgetevents);
    eval 'sub __NR_migrate_pages () {( &__NR_SYSCALL_BASE + 400);}' unless defined(&__NR_migrate_pages);
    eval 'sub __NR_kexec_file_load () {( &__NR_SYSCALL_BASE + 401);}' unless defined(&__NR_kexec_file_load);
    eval 'sub __NR_clock_gettime64 () {( &__NR_SYSCALL_BASE + 403);}' unless defined(&__NR_clock_gettime64);
    eval 'sub __NR_clock_settime64 () {( &__NR_SYSCALL_BASE + 404);}' unless defined(&__NR_clock_settime64);
    eval 'sub __NR_clock_adjtime64 () {( &__NR_SYSCALL_BASE + 405);}' unless defined(&__NR_clock_adjtime64);
    eval 'sub __NR_clock_getres_time64 () {( &__NR_SYSCALL_BASE + 406);}' unless defined(&__NR_clock_getres_time64);
    eval 'sub __NR_clock_nanosleep_time64 () {( &__NR_SYSCALL_BASE + 407);}' unless defined(&__NR_clock_nanosleep_time64);
    eval 'sub __NR_timer_gettime64 () {( &__NR_SYSCALL_BASE + 408);}' unless defined(&__NR_timer_gettime64);
    eval 'sub __NR_timer_settime64 () {( &__NR_SYSCALL_BASE + 409);}' unless defined(&__NR_timer_settime64);
    eval 'sub __NR_timerfd_gettime64 () {( &__NR_SYSCALL_BASE + 410);}' unless defined(&__NR_timerfd_gettime64);
    eval 'sub __NR_timerfd_settime64 () {( &__NR_SYSCALL_BASE + 411);}' unless defined(&__NR_timerfd_settime64);
    eval 'sub __NR_utimensat_time64 () {( &__NR_SYSCALL_BASE + 412);}' unless defined(&__NR_utimensat_time64);
    eval 'sub __NR_pselect6_time64 () {( &__NR_SYSCALL_BASE + 413);}' unless defined(&__NR_pselect6_time64);
    eval 'sub __NR_ppoll_time64 () {( &__NR_SYSCALL_BASE + 414);}' unless defined(&__NR_ppoll_time64);
    eval 'sub __NR_io_pgetevents_time64 () {( &__NR_SYSCALL_BASE + 416);}' unless defined(&__NR_io_pgetevents_time64);
    eval 'sub __NR_recvmmsg_time64 () {( &__NR_SYSCALL_BASE + 417);}' unless defined(&__NR_recvmmsg_time64);
    eval 'sub __NR_mq_timedsend_time64 () {( &__NR_SYSCALL_BASE + 418);}' unless defined(&__NR_mq_timedsend_time64);
    eval 'sub __NR_mq_timedreceive_time64 () {( &__NR_SYSCALL_BASE + 419);}' unless defined(&__NR_mq_timedreceive_time64);
    eval 'sub __NR_semtimedop_time64 () {( &__NR_SYSCALL_BASE + 420);}' unless defined(&__NR_semtimedop_time64);
    eval 'sub __NR_rt_sigtimedwait_time64 () {( &__NR_SYSCALL_BASE + 421);}' unless defined(&__NR_rt_sigtimedwait_time64);
    eval 'sub __NR_futex_time64 () {( &__NR_SYSCALL_BASE + 422);}' unless defined(&__NR_futex_time64);
    eval 'sub __NR_sched_rr_get_interval_time64 () {( &__NR_SYSCALL_BASE + 423);}' unless defined(&__NR_sched_rr_get_interval_time64);
    eval 'sub __NR_pidfd_send_signal () {( &__NR_SYSCALL_BASE + 424);}' unless defined(&__NR_pidfd_send_signal);
    eval 'sub __NR_io_uring_setup () {( &__NR_SYSCALL_BASE + 425);}' unless defined(&__NR_io_uring_setup);
    eval 'sub __NR_io_uring_enter () {( &__NR_SYSCALL_BASE + 426);}' unless defined(&__NR_io_uring_enter);
    eval 'sub __NR_io_uring_register () {( &__NR_SYSCALL_BASE + 427);}' unless defined(&__NR_io_uring_register);
    eval 'sub __NR_open_tree () {( &__NR_SYSCALL_BASE + 428);}' unless defined(&__NR_open_tree);
    eval 'sub __NR_move_mount () {( &__NR_SYSCALL_BASE + 429);}' unless defined(&__NR_move_mount);
    eval 'sub __NR_fsopen () {( &__NR_SYSCALL_BASE + 430);}' unless defined(&__NR_fsopen);
    eval 'sub __NR_fsconfig () {( &__NR_SYSCALL_BASE + 431);}' unless defined(&__NR_fsconfig);
    eval 'sub __NR_fsmount () {( &__NR_SYSCALL_BASE + 432);}' unless defined(&__NR_fsmount);
    eval 'sub __NR_fspick () {( &__NR_SYSCALL_BASE + 433);}' unless defined(&__NR_fspick);
    eval 'sub __NR_pidfd_open () {( &__NR_SYSCALL_BASE + 434);}' unless defined(&__NR_pidfd_open);
    eval 'sub __NR_clone3 () {( &__NR_SYSCALL_BASE + 435);}' unless defined(&__NR_clone3);
}
1;
