 ...
 */
#define ARCHLIB "/usr/lib/aarch64-linux-gnu/perl/5.22"		/**/
#define ARCHLIB_EXP "/usr/lib/aarch64-linux-gnu/perl/5.22"		/**/
 ...
 *	in programs that are not prepared to deal with ~ expansion at run-time.
 */
#define SITEARCH "/usr/local/lib/aarch64-linux-gnu/perl/5.22.1"		/**/
#define SITEARCH_EXP "/usr/local/lib/aarch64-linux-gnu/perl/5.22.1"		/**/
 ...
 *	in programs that are not prepared to deal with ~ expansion at run-time.
 */
#define PERL_VENDORARCH "/usr/lib/aarch64-linux-gnu/perl5/5.22"		/**/
#define PERL_VENDORARCH_EXP "/usr/lib/aarch64-linux-gnu/perl5/5.22"		/**/
