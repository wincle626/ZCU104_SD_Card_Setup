...
if(!defined (&__AARCH64EB__)) {
    ...
    eval 'sub SYS_arch_specific_syscall () { &__NR_arch_specific_syscall;}' unless defined(&SYS_arch_specific_syscall);
    ...
    eval 'sub SYS_syscalls () { &__NR_syscalls;}' unless defined(&SYS_syscalls);
