...
/* enumerations from "../../../../gst-plugins-base-0.10.36/gst-libs/gst/pbutils/gstdiscoverer.h" */
GType gst_discoverer_result_get_type (void);
#define GST_TYPE_DISCOVERER_RESULT (gst_discoverer_result_get_type())

/* enumerations from "../../../../gst-plugins-base-0.10.36/gst-libs/gst/pbutils/install-plugins.h" */
