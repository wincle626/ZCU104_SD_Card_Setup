...
/* enumerations from "../../../../gst-plugins-base-0.10.36/gst-libs/gst/interfaces/colorbalance.h" */
GType gst_color_balance_type_get_type (void);
#define GST_TYPE_COLOR_BALANCE_TYPE (gst_color_balance_type_get_type())

/* enumerations from "../../../../gst-plugins-base-0.10.36/gst-libs/gst/interfaces/mixer.h" */
...
/* enumerations from "../../../../gst-plugins-base-0.10.36/gst-libs/gst/interfaces/mixertrack.h" */
GType gst_mixer_track_flags_get_type (void);
#define GST_TYPE_MIXER_TRACK_FLAGS (gst_mixer_track_flags_get_type())

/* enumerations from "../../../../gst-plugins-base-0.10.36/gst-libs/gst/interfaces/navigation.h" */
...
/* enumerations from "../../../../gst-plugins-base-0.10.36/gst-libs/gst/interfaces/streamvolume.h" */
GType gst_stream_volume_format_get_type (void);
#define GST_TYPE_STREAM_VOLUME_FORMAT (gst_stream_volume_format_get_type())

/* enumerations from "../../../../gst-plugins-base-0.10.36/gst-libs/gst/interfaces/tunerchannel.h" */
